...
translator.translate = function() {
    ...
    for (var character of inputArray) {
...
var toPage = translator.translate();
//var toEnglishTranslator = toPage.replace(/\|/g, " ");
console.log(toPage);
//console.log(toEnglishTranslator);

document.getElementById('result').innerHTML = toPage;
